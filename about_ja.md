...
*   **よくある質問（ユーザーの悩み）：**
    *   「何十ターンも会話を続けていると、AIが最初の方に教えたルールを忘れてしまいます。その都度『思い出して』とチャットで注意し直すしかないのでしょうか？」
    *   「最初は具体的で面白いアイデアをくれていたのに、会話が進むとどんどん当たり障りのない無難な回答に逃げてしまうのは防げませんか？」
*   **AIが出力する一般的な回答：**
...
*   **よくある質問（ユーザーの悩み）：**
    *   「CLAUDE.mdやシステムプロンプトにルールを追加していくと、ある指示を守る代わりに別の指示を無視し始めます。競合をなくすためにプロンプトをどう整理すればいいですか？」
    *   「ルールを徹底させようと指示を細かく書き足すほど、AIの出力スピードが落ちたり、挙動が不安定になってしまうのはなぜですか？」
*   **AIが出力する一般的な回答：**
...
*   **よくある質問（ユーザーの悩み）：**
    *   「過去のチャット履歴や仕様書をAIのプロジェクト機能（RAG）に全部読み込ませたら、すでにボツになった古いデータをAIがゾンビのように引っ張ってきてしまいます。どうやってクレンジングすればいいですか？」
    *   「データ量が増えた途端にAIの回答精度がガタ落ちしました。データの分割（チャンク）や検索システムの設定自体をやり直さないと駄目でしょうか？」
*   **AIが出力する一般的な回答：**
...
*   **よくある質問（ユーザーの悩み）：**
    *   「ブレストでAIに自分のアイデアをレビューさせると、『素晴らしいですね！』と褒めてばかりで、問題点やバグを全然指摘してくれません。本気で厳しく批評してもらう方法はありませんか？」
    *   「AIが出してきた謝罪や『修正しました』という完璧そうな流暢な説明を、ついそのまま信じて妥協してしまいます。目視での検品（ファクトチェック）作業から解放されるにはどうすればいいですか？」
*   **AIが出力する一般的な回答：**
...
*   **よくある質問（ユーザーの悩み）：**
    *   「自分が作ったすごく使いやすいプロンプトをチームに共有したのですが、他のメンバーが使うと全然いい回答が出ません。プロンプトエンジニアリングは結局、個人のスキルやセンスに依存するのでしょうか？」
    *   「プロンプトの使い方マニュアルを作って配ったのですが、メンバーによってAIの使いこなしに大きな差が出てしまい、成果物の品質を均一化できません。どうすれば仕組み化できますか？」
*   **AIが出力する一般的な回答：**
