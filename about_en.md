...
<style>
  ...
  .pe-timeline-table tbody tr:nth-child(even) {
    background-color: #fafafa;
  }
  
  .pe-timeline-table tbody tr:hover {
    background-color: #f4f4f5;
  ...
  .pe-timeline-table tbody tr:last-child td {
    border-bottom: none;
  }
</style>
